const CACHE='athena-os-v2.4.0';
const CORE=[
  './','./index.html','./styles.css','./manifest.webmanifest','./assets/athena-mark.svg',
  './js/app.js','./js/utils.js','./js/data.js','./js/state-engine.js','./js/event-tools.js','./js/health.js','./js/research-ui.js','./js/prospective.js','./js/performance-log.js','./js/pallas.js',
