...
function renderResearch(d){
  ...
  if($('#proofAthletes')) $('#proofAthletes').textContent=Number(d.dataset.athletes_used).toLocaleString();
  if($('#proofRecords')) $('#proofRecords').textContent=Number(d.dataset.raw_joined_rows).toLocaleString();
  if($('#proofSamples')) $('#proofSamples').textContent=Number(d.dataset.prediction_samples).toLocaleString();
  if($('#proofFolds')) $('#proofFolds').textContent=`${roll.improved_folds}/${roll.total_folds}`;
...
function renderEvidenceIntegrity(i,r,w){
  ...
  if($('#proofIntegrity')) $('#proofIntegrity').textContent=`${i.checks_passed}/${i.checks_total}`;
